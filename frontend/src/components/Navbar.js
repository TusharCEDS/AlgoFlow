    ...
    <nav className="flex items-center justify-between px-8 py-4 border-b border-gray-800 bg-gray-950">
      ...
      <div className="flex gap-4 items-center">
        {authState.isLoggedIn ? (
          <>
            <Link href="/battle" className="text-gray-400 hover:text-white transition py-2">
              ⚔️ Battle
            </Link>
            <Link href="/problems" className="text-gray-400 hover:text-white transition py-2">
              Problems
            </Link>
            <Link href="/dashboard" className="text-gray-400 hover:text-white transition py-2">
              Dashboard
            </Link>
            <button
          ...
          <>
            ...
            <Link href="/login" className="text-gray-400 hover:text-white transition py-2">
              Login
            </Link>
